...
const products = [
  ['anarkali-noor',      { ...PRODUCT, ground: P.bone,      accent: P.henna,     motif: 'suzani',   glowFrom: '#F7F1E8', glowTo: '#E3D6C6' }],
  ['anarkali-noor-alt',  { ...PRODUCT, ground: P.alabaster, accent: P.hennaDeep, motif: 'butti',    glowFrom: '#FBF7F1', glowTo: '#E8DCCB' }],
  ['lehenga-sanjh',      { ...PRODUCT, ground: P.clay,      accent: P.plum,      motif: 'jaali',    glowFrom: '#EFE3D6', glowTo: '#D8C2B6' }],
  ['lehenga-sanjh-alt',  { ...PRODUCT, ground: P.bone,      accent: P.rose,      motif: 'bandhani', glowFrom: '#F6EDE6', glowTo: '#DFC9C2' }],
  ...
  ['saree-zohra',        { ...PRODUCT, ground: P.bone,      accent: P.marigold,  motif: 'zari',     glowFrom: '#FBF4E4', glowTo: '#E9D5AE' }],
  ['saree-zohra-alt',    { ...PRODUCT, ground: P.alabaster, accent: P.marigold,  motif: 'butti',    glowFrom: '#FDF8EC', glowTo: '#EFDCBB' }],
  ['sharara-gulnaz',     { ...PRODUCT, ground: P.clay,      accent: P.henna,     motif: 'ikat',     glowFrom: '#F3E7DA', glowTo: '#DEC3AE' }],
  ['sharara-gulnaz-alt', { ...PRODUCT, ground: P.bone,      accent: P.hennaDeep, motif: 'kantha',   glowFrom: '#F5EBE1', glowTo: '#E0CAB6' }],
  ...
  ['jacket-parvaaz',     { ...PRODUCT, ground: P.bone,      accent: P.indigo,    motif: 'suzani',   glowFrom: '#F1F2F4', glowTo: '#CFD5DC' }],
  ['jacket-parvaaz-alt', { ...PRODUCT, ground: P.alabaster, accent: P.indigoDeep,motif: 'ikat',     glowFrom: '#F4F5F7', glowTo: '#D6DBE1' }],
  ['kaftan-noorjahan',   { ...PRODUCT, ground: P.alabaster, accent: P.plum,      motif: 'butti',    glowFrom: '#F7F1F3', glowTo: '#DCC9D0' }],
  ['kaftan-noorjahan-alt',{...PRODUCT, ground: P.bone,      accent: P.rose,      motif: 'suzani',   glowFrom: '#F8F0F0', glowTo: '#E0C7C9' }],
  ['blouse-meher',       { ...PRODUCT, ground: P.bone,      accent: P.marigold,  motif: 'kantha',   glowFrom: '#FAF3E6', glowTo: '#E7D3B2' }],
  ['blouse-meher-alt',   { ...PRODUCT, ground: P.clay,      accent: P.henna,     motif: 'zari',     glowFrom: '#F2E7DB', glowTo: '#DDC4B2' }],
  ...
  ['gharara-aftab',      { ...PRODUCT, ground: P.clay,      accent: P.hennaDeep, motif: 'jaali',    glowFrom: '#F1E5D8', glowTo: '#D9C0AC' }],
  ['gharara-aftab-alt',  { ...PRODUCT, ground: P.bone,      accent: P.marigold,  motif: 'bandhani', glowFrom: '#FAF3E5', glowTo: '#E6D2AF' }],
];
...
const tiles = [
  ['cat-bridal',    { w: 1000, h: 1250, ground: P.clay,      accent: P.henna,     motif: 'suzani'  , glowFrom: '#EFE1D2', depth: 0.9, glowTo: '#6B5544' }],
  ['cat-festive',   { w: 1000, h: 1250, ground: P.bone,      accent: P.marigold,  motif: 'zari'    , glowFrom: '#FAF2E1', depth: 0.9, glowTo: '#8A6C3C' }],
  ['cat-menswear',  { w: 1000, h: 1250, ground: P.alabaster, accent: P.indigo,    motif: 'khadi'   , glowFrom: '#EEF0F3', depth: 0.9, glowTo: '#4A5563' }],
